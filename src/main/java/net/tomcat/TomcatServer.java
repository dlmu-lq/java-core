...
import net.tomcat.request.LlServletRequest;
import net.tomcat.request.NtServletRequest;
import net.tomcat.response.LlServletResponse;
import net.tomcat.response.NtServletResponse;
