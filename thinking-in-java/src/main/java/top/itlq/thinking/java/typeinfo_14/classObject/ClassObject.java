package top.itlq.thinking.java.typeinfo_14.classObject;
...
public class ClassObject {
    ...
    public void loadClass(){
        ...
        // 加载类必须使用全名
        try {
            Class.forName("top.itlq.thinking.java.typeinfo_14.classObject.Shape");
        } catch (ClassNotFoundException e) {
            System.out.println("class not found: Shape");
        }

        try {
            Class.forName("top.itlq.thinking.java.typeinfo_14.classObject.Toy");
    ...
    public void classMethods(){
        Class apple = null;
        try {
            apple = Class.forName("top.itlq.thinking.java.typeinfo_14.classObject.Apple");
